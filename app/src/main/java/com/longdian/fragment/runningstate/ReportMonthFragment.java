...
public class ReportMonthFragment extends BaseDatePickerFragment {
    ...
    private void getData() {
        HoolaiHttpMethods.getInstance().reportMonth(getActivity(), "2017-06-17", "", new ObserverOnNextAndErrorListener<List<Map<String, String>>>() {
            @Override
